...
public class ThematicDialog extends AppCompatDialogFragment {

    private ThematicDialog.ThematicDialogListener listener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View placesView = inflater.inflate(R.layout.thematic_dilalog, null);
    ...
    public void onAttach(Context context) {
        ...
        try {
            listener = (ThematicDialogListener) context;
    ...
    public interface ThematicDialogListener{
